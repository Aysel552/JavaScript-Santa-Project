function christmasCountdown() {
    ...
    const displayInMinute = Math.floor((diff % msInHour) / msInMinute);
    document.querySelector(".minutes").textContent = displayInMinute;
...
const buttonPause = document.querySelector("#myButtonStop");
